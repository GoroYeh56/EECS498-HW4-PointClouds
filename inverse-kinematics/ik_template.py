...
def get_translation_jacobian(robot, joint_indices, current_ee_position):
    ...
    for i in range(len(joint_indices)):
        ...
        # p = get_joint_position(robot, joint_indices[i])
        P[:,i] = p
...
def main():
    ...
    def Iterative_Inverse_Kinematics(robot, joint_idx, joint_limits, qint, xtarget, threshold = 0.1, alpha=0.05,MAX_ITER=100):
        """
    ...
    qfinal = Iterative_Inverse_Kinematics(robot, joint_idx, JL, qint, xtarget, threshold, alpha, MAX_ITER)
    print("qfinal: ", qfinal)
