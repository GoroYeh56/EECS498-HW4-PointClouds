...
def add_outliers_centroid(pc, num_outliers, variance, distribution='gaussian'):
    ...
    outputs:
        ...
        1. Find the centroid of the whole point cloud
        2. append centroid to each newpoints
        3. merge_clouds(pc, add_noise())
            => Add 'gaussion' noise to these centroids, with (mean, var) and merge to pc
